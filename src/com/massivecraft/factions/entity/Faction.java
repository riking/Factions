...
public class Faction extends Entity<Faction> implements EconomyParticipator
{
	...
	// Null means the faction has default boost.
	...
	public double getDefaultPowerBoost()
	{
	       return UConf.get(this).defaultPlayerPowerBoost;
	}

	public double getPowerBoost()
	{
		Double ret = this.powerBoost;
		if (ret == null) ret = getDefaultPowerBoost();
		return ret;
	}
	...
	public void setPowerBoost(Double powerBoost)
	{
		...
		if (target == null || target == getDefaultPowerBoost()) target = null;
